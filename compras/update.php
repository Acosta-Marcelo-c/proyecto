...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Actualizacion de la compra No. <?php echo $show_nro_compra;?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Actualzacion Compra </h3>
                                                ...
                                                <tr>
                                                  ...
                                                  <script>
                                                      $('#btn_seleccionar_proveedor<?php echo $id_Proveedor;?>').click(function(){
                                                        ...
                                                        var celular ="<?php echo $proveedor_dato['pro_Celular'];?>";
                                                        $('#celular_pro').val(celular);
                                                        var telefono ="<?php echo $proveedor_dato['pro_Telefono'];?>";
                                                        $('#telefono_pro').val(telefono);
                                                        var ruc ="<?php echo $proveedor_dato['pro_Ruc'];?>";
                                                        $('#ruc_pro').val(ruc);
                                                        var email ="<?php echo $proveedor_dato['pro_Email'];?>";
                                                        $('#email_pro').val(email);
                                                        var direccion ="<?php echo $proveedor_dato['pro_Direccion'];?>";
                                                  ...
                                                  <td>
                                                    <a href="https://wa.me/593<?php echo $proveedor_dato['pro_Celular'];?>" target="-_blank">
                                                      <i class="fa fa-phone"><?php echo $proveedor_dato['pro_Celular'];?></i>
                                                    </a>
                                                    </td>
                             ...
                             <div class="row">
                               ...
                               <div class="col-md-4">
                                 <div class="form-group">
                                   ...
                                   <input type="text"  value="<?php echo $show_codigo;?>" class="form-control" id="codigo" disabled>
                                 </div>
                               </div>
                               ...
                               <div class="col-md-4">
                                 <div class="form-group">
                                   ...
                                   <input type="text" class="form-control"  value="<?php echo $show_nombreProdu; ?>"name="nombre" id="nombre_producto"disabled>
                                 </div>
                               </div>
                             ...
                             <div class="row">
                               <div class="col-md-4">
                                 <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" value="<?php echo $show_usuario; ?>" id="usuario_producto"disabled>
                             ...
                             <div class="row">
                               <div class="col-md-2">
                                 <div class="form-group">
                                   ...
                                   <input type="number" name="stock" class="form-control" value="<?php echo $show_stock;?>" placeholder="" id="stock" style="background-color: #fff819" disabled>
                                 </div>
                               </div>
                               <div class="col-md-2">
                                 <div class="form-group">
                                   <label for="">Stock Min:</label>
                                   <input type="number" name="stock_minimo"class="form-control" value="<?php echo $show_StockMinimo;?>" id="stock_minimo" disabled>
                                 </div>
                               </div>
                               <div class="col-md-2">
                                 <div class="form-group">
                    ...
                    <div class="container-fluid" style="font-size: 12px">
                          <div class="row">
                              <div class="col-md-4">
                                <div class="form-group">
                                  <input type="text" value="<?php echo $show_id_Proveedor;?>" id="id_provee" hidden>
                                  <label for="">Nombre Proveedor:</label>
                                  <input type="text" class="form-control" id="nombre_pro" value="<?php echo$show_nomProveedor; ?>" disabled>
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <div  style="display: flex">
                                      <input type="text" class="form-control" id="celular_pro" value="<?php echo $show_celProveedor; ?>"  disabled>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="nombre" id="telefono_pro" value="<?php echo $show_tefProveedor; ?>" disabled>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label for="">RUC:</label>
                                  <input type="text" class="form-control" id="ruc_pro" value="<?php echo $show_rucProveedor; ?>" disabled>
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label for="">email:</label>
                                  <input type="text" class="form-control" id="email_pro" value="<?php echo $show_emailProveedor; ?>" disabled>
                                </div>
                              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="nro_compra" value="<?php echo $show_nro_compra ?>"class="form-control" style="text-align: center" disabled>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="">fecha de compra</label>
                    <input type="date" class="form-control" value="<?php echo $show_fecha; ?>" id="fecha_compra">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="">Comprobante de compra</label>
                    <input type="text" class="form-control" value="<?php echo $show_comprobante; ?>" id="comprobante">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="">precio compra</label>
                    <input type="number" class="form-control" value="<?php echo $show_precioCompra; ?>" id="precio_com">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="number" id="cantidad_compra" value="<?php echo $show_cantidadCompra; ?>" style="text-align: center" class="form-control">
                </div>
                <script>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <button class="btn btn-primary btn-block" id="btn_actualizar_compra">Guardar Compra </button>
                  </div>
                </div>
                <script>
                  ('#btn_actualizar_compra').click(function(){
                    var id_compra ='<?php echo $show_id_compra ?>';
                      ...
                      if (id_compra =="") {
                      alert('no se encuentra id compra');
                      }else
                      if (id_prod =="") {
                      $('#id_producto').focus();
                    ...
                    alert('debe llenar la cantidad de compra');
                      ...
                      var url="../app/controlador/compras/update_compras.php";
                         $.get(url,{id_Compra:id_compra,
                                    nro_Compra:nro_compra,
                                    id_Almacen:id_prod,
                                    com_Fecha:fecha_compra,
                                    id_Proveedor:id_provee,
                                    com_Comprobante:comprobante,
                                    id_pers:id_usuario,
