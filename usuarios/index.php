        ...
        <div class="col-md-12">
          <div class="card card-outline cart-primary">
            <div class="card-header">
              <h1 class="card-title"><i class="fa fa-list-alt" aria-hidden="true"></i><b> LISTA DE USUARIOS</b></h1>
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <!--<td> <?php //echo $usuarios_dato['per_Contrase']
                                ?></td>-->
                      <!--<td> <?php echo $usuarios_dato['per_Fecha_Creacion'] ?></td>-->

                      <?php if ($usuarios_dato['rol_nombre'] == "NUEVO") { ?>
                        <td style="background-color: #FFA07A"><?php echo $usuarios_dato['rol_nombre']; ?>
                        <?php
                      } else {
                        ?>
                        <td>
                        <?php
                        echo $usuarios_dato['rol_nombre'];
                      } ?>
                        </td>
                        <td> <?php echo $usuarios_dato['per_Estado'] ?>
                        </td>
                        <td> <?php echo $usuarios_dato['Empresa'] ?></td>
                        <td>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="empresa" name="email" class="form-control" value="<?php echo $usuarios_dato['Empresa']; ?>" disabled>
                                </div>
                              </div>
                            </div>
                            <!--</form> -->
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <select id="estado<?php echo $id_usuario; ?>" class="form-control">
                                    ...
                                    <option value="Inactivo" <?php if ($Estado == "Inactivo") { ?> selected="select" <?php } ?>>Inactivo</option>
                                  </select>
                                </div>
                              </div>
                              <div class="col-md-6">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <select name="empresa" id="empresa_usuario" class="form-control">
                                    <?php
                                    foreach ($parametro_datos as $parametro_dato) { ?>

                                      <option value="<?php echo $parametro_dato['id_Param']; ?>">
                                        <?php echo $parametro_dato['par_Nom_Empre']; ?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="estado" id="estado_usuario1" class="form-control">
...
<script>
  $('#btn_create').click(function() {
    ...
    var estado_usuario = $('#estado_usuario1').val();
    ...
    } else if (empresa_usuario == "") {
      $('#empresa_usuario').focus();
