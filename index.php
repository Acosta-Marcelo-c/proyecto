                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <a href="factura.php?no_pedido=<?php echo $no_pedido; ?>&id_ventas=<?php echo $id_ventas; ?>&id_param=<?php echo $id_param; ?>" class="btn btn-success"><i class="fa fa-print"></i>Imprimir</a>
                                                </center>
                                            </td>
                                        </tr>
                                    <?php } ?>
