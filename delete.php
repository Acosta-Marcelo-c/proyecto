                    ...
                    <div class="card  card-outline card-danger">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-shopping-bag"></i> Venta No.-
                                <input type="text" id="nro_venta" style="text-align: center" value="<?php echo $nro_venta; ?>" disabled>
                            </h3>
                                    ...
                                    ?>
                                        <tr>
                                            <td> <?php echo $contador_listaPedido; ?>
                                                <input type="text" hidden id="id_almacen<?php echo $contador_listaPedido; ?>" value="<?php echo $id_almacen; ?>">
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <input type="text" hidden id="stock_almacen<?php echo $contador_listaPedido; ?>" value="<?php echo $pedido_dato['alm_Stock']; ?>">
                                            </td>
                                            <td>
