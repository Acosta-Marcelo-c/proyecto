        ...
        <div class="col-sm-12">
          <h1 class="m-0">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-create">
              <i class="fa fa-check" aria-hidden="true"></i> Agregar Nuevo Rol
            </button>
          </h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
        ...
        <div class="col-md-12">
          <div class="card card-outline cart-primary">
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-list-alt" aria-hidden="true"></i> <b>Roles Regitrados</b></h3>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#modal-editar<?php echo $id_Rol; ?>"><i class="fa fa-pencil-alt"></i> Editar</button>
